...
import chart1shadow from "../../../public/images/chart1shadow.svg";
import shiftIcon from "../../../public/images/shift.svg";
import chart2 from "../../../public/images/chart2.svg";
import chart2shadow from "../../../public/images/chart2shadow.svg";
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-5 mt-[27px]">
      ...
      <div className="w-[50%] lg:w-[30.5%] h-auto font-inter bg-white rounded-[10px] px-4 py-[21px]">
        ...
        <div className="flex gap-[84px] mt-[51px]">
          <div>
            <p className="text-[32px] font-bold leading-[39px] text-dark">24</p>
            <p className="text-sm font-normal leading-[17px] text-greysixty">
              Requests
            </p>
          </div>
